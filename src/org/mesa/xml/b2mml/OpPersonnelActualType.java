 ...
 *         &lt;element name="PersonnelActualChild" type="{http://www.mesa.org/xml/B2MML}OpPersonnelActualType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OpPersonnelActualType {
    ...
    @XmlElement(name = "PersonnelActualChild")
    protected List<OpPersonnelActualType> personnelActualChild;
    ...
    /**
     * Gets the value of the personnelActualChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the personnelActualChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPersonnelActualChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpPersonnelActualType> getPersonnelActualChild() {
        if (personnelActualChild == null) {
            personnelActualChild = new ArrayList<OpPersonnelActualType>();
        }
        return this.personnelActualChild;
    }
