 ...
 *         &lt;element name="EquipmentSpecificationChild" type="{http://www.mesa.org/xml/B2MML}OpEquipmentSpecificationType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OpEquipmentSpecificationType {
    ...
    @XmlElement(name = "EquipmentSpecificationChild")
    protected List<OpEquipmentSpecificationType> equipmentSpecificationChild;
    ...
    /**
     * Gets the value of the equipmentSpecificationChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the equipmentSpecificationChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEquipmentSpecificationChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpEquipmentSpecificationType> getEquipmentSpecificationChild() {
        if (equipmentSpecificationChild == null) {
            equipmentSpecificationChild = new ArrayList<OpEquipmentSpecificationType>();
        }
        return this.equipmentSpecificationChild;
    }
