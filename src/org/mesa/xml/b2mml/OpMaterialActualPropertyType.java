 ...
 *         &lt;element name="MaterialActualPropertyChild" type="{http://www.mesa.org/xml/B2MML}OpMaterialActualPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OpMaterialActualPropertyType {
    ...
    @XmlElement(name = "MaterialActualPropertyChild")
    protected List<OpMaterialActualPropertyType> materialActualPropertyChild;
    ...
    /**
     * Gets the value of the materialActualPropertyChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the materialActualPropertyChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMaterialActualPropertyChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpMaterialActualPropertyType> getMaterialActualPropertyChild() {
        if (materialActualPropertyChild == null) {
            materialActualPropertyChild = new ArrayList<OpMaterialActualPropertyType>();
        }
        return this.materialActualPropertyChild;
    }
