 ...
 *         &lt;element name="PersonnelRequirementPropertyChild" type="{http://www.mesa.org/xml/B2MML}OpPersonnelRequirementPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OpPersonnelRequirementPropertyType {
    ...
    @XmlElement(name = "PersonnelRequirementPropertyChild")
    protected List<OpPersonnelRequirementPropertyType> personnelRequirementPropertyChild;
    ...
    /**
     * Gets the value of the personnelRequirementPropertyChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the personnelRequirementPropertyChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPersonnelRequirementPropertyChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpPersonnelRequirementPropertyType> getPersonnelRequirementPropertyChild() {
        if (personnelRequirementPropertyChild == null) {
            personnelRequirementPropertyChild = new ArrayList<OpPersonnelRequirementPropertyType>();
        }
        return this.personnelRequirementPropertyChild;
    }
