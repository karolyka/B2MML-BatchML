 ...
 *         &lt;element name="EquipmentChild" type="{http://www.mesa.org/xml/B2MML}EquipmentType" maxOccurs="unbounded" minOccurs="0"/>
...
public class EquipmentType {
    ...
    @XmlElement(name = "EquipmentChild")
    protected List<EquipmentType> equipmentChild;
    ...
    /**
     * Gets the value of the equipmentChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the equipmentChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEquipmentChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EquipmentType> getEquipmentChild() {
        if (equipmentChild == null) {
            equipmentChild = new ArrayList<EquipmentType>();
        }
        return this.equipmentChild;
    }
