 ...
 *         &lt;element name="EquipmentActualChild" type="{http://www.mesa.org/xml/B2MML}OpEquipmentActualType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OpEquipmentActualType {
    ...
    @XmlElement(name = "EquipmentActualChild")
    protected List<OpEquipmentActualType> equipmentActualChild;
    ...
    /**
     * Gets the value of the equipmentActualChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the equipmentActualChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEquipmentActualChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpEquipmentActualType> getEquipmentActualChild() {
        if (equipmentActualChild == null) {
            equipmentActualChild = new ArrayList<OpEquipmentActualType>();
        }
        return this.equipmentActualChild;
    }
