 ...
 *         &lt;element name="EquipmentCapabilityPropertyChild" type="{http://www.mesa.org/xml/B2MML}OpEquipmentCapabilityPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "OpEquipmentCapabilityPropertyType", propOrder = {
    ...
    "value",
    "quantity",
    "equipmentCapabilityPropertyChild",
...
public class OpEquipmentCapabilityPropertyType {
    ...
    @XmlElement(name = "EquipmentCapabilityPropertyChild")
    protected List<OpEquipmentCapabilityPropertyType> equipmentCapabilityPropertyChild;
    ...
    /**
     * Gets the value of the equipmentCapabilityPropertyChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the equipmentCapabilityPropertyChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEquipmentCapabilityPropertyChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpEquipmentCapabilityPropertyType> getEquipmentCapabilityPropertyChild() {
        if (equipmentCapabilityPropertyChild == null) {
            equipmentCapabilityPropertyChild = new ArrayList<OpEquipmentCapabilityPropertyType>();
        }
        return this.equipmentCapabilityPropertyChild;
    }
