 ...
 *         &lt;element name="EquipmentCapabilityChild" type="{http://www.mesa.org/xml/B2MML}OpEquipmentCapabilityType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OpEquipmentCapabilityType {
    ...
    @XmlElement(name = "EquipmentCapabilityChild")
    protected List<OpEquipmentCapabilityType> equipmentCapabilityChild;
    ...
    /**
     * Gets the value of the equipmentCapabilityChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the equipmentCapabilityChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEquipmentCapabilityChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpEquipmentCapabilityType> getEquipmentCapabilityChild() {
        if (equipmentCapabilityChild == null) {
            equipmentCapabilityChild = new ArrayList<OpEquipmentCapabilityType>();
        }
        return this.equipmentCapabilityChild;
    }
