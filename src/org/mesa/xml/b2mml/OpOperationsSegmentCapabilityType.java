...
/**
 * <p>Java class for OpOperationsSegmentCapabilityType complex type.
 * 
 ...
 *         &lt;element name="OperationsSegmentCapabilityChild" type="{http://www.mesa.org/xml/B2MML}OpOperationsSegmentCapabilityType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "OpOperationsSegmentCapabilityType", propOrder = {
    ...
    "materialCapability",
    "operationsSegmentCapabilityChild"
})
public class OpOperationsSegmentCapabilityType {
    ...
    @XmlElement(name = "OperationsSegmentCapabilityChild")
    protected List<OpOperationsSegmentCapabilityType> operationsSegmentCapabilityChild;
    ...
    /**
     * Gets the value of the operationsSegmentCapabilityChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the operationsSegmentCapabilityChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOperationsSegmentCapabilityChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpOperationsSegmentCapabilityType> getOperationsSegmentCapabilityChild() {
        if (operationsSegmentCapabilityChild == null) {
            operationsSegmentCapabilityChild = new ArrayList<OpOperationsSegmentCapabilityType>();
        }
        return this.operationsSegmentCapabilityChild;
    }
