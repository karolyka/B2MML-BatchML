 ...
 *         &lt;element name="EquipmentPropertyChild" type="{http://www.mesa.org/xml/B2MML}EquipmentPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
public class EquipmentPropertyType {
    ...
    @XmlElement(name = "EquipmentPropertyChild")
    protected List<EquipmentPropertyType> equipmentPropertyChild;
    ...
    /**
     * Gets the value of the equipmentPropertyChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the equipmentPropertyChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEquipmentPropertyChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EquipmentPropertyType> getEquipmentPropertyChild() {
        if (equipmentPropertyChild == null) {
            equipmentPropertyChild = new ArrayList<EquipmentPropertyType>();
        }
        return this.equipmentPropertyChild;
    }
