...
/**
 * <p>Java class for WorkCalendarDefinitionType complex type.
 * 
 ...
 *         &lt;element name="WorkCalendarDefinitionEntry" type="{http://www.mesa.org/xml/B2MML}WorkCalendarDefinitionEntryType" maxOccurs="unbounded"/>
 *         &lt;element name="WorkCalendarDefinitionProperty" type="{http://www.mesa.org/xml/B2MML}WorkCalendarDefinitionPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
public class WorkCalendarDefinitionType {
    ...
    @XmlElement(name = "WorkCalendarDefinitionEntry", required = true)
    protected List<WorkCalendarDefinitionEntryType> workCalendarDefinitionEntry;
    @XmlElement(name = "WorkCalendarDefinitionProperty")
    protected List<WorkCalendarDefinitionPropertyType> workCalendarDefinitionProperty;
    ...
    /**
     * Gets the value of the workCalendarDefinitionProperty property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the workCalendarDefinitionProperty property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWorkCalendarDefinitionProperty().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<WorkCalendarDefinitionPropertyType> getWorkCalendarDefinitionProperty() {
        if (workCalendarDefinitionProperty == null) {
            workCalendarDefinitionProperty = new ArrayList<WorkCalendarDefinitionPropertyType>();
        }
        return this.workCalendarDefinitionProperty;
    }
