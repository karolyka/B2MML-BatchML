 ...
 *         &lt;element name="EquipmentActualPropertyChild" type="{http://www.mesa.org/xml/B2MML}OpEquipmentActualPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OpEquipmentActualPropertyType {
    ...
    @XmlElement(name = "EquipmentActualPropertyChild")
    protected List<OpEquipmentActualPropertyType> equipmentActualPropertyChild;
    ...
    /**
     * Gets the value of the equipmentActualPropertyChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the equipmentActualPropertyChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEquipmentActualPropertyChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpEquipmentActualPropertyType> getEquipmentActualPropertyChild() {
        if (equipmentActualPropertyChild == null) {
            equipmentActualPropertyChild = new ArrayList<OpEquipmentActualPropertyType>();
        }
        return this.equipmentActualPropertyChild;
    }
