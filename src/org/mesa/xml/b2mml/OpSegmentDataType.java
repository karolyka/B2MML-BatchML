 ...
 *         &lt;element name="SegmentDataChild" type="{http://www.mesa.org/xml/B2MML}OpSegmentDataType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OpSegmentDataType {
    ...
    @XmlElement(name = "SegmentDataChild")
    protected List<OpSegmentDataType> segmentDataChild;
    ...
    /**
     * Gets the value of the segmentDataChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the segmentDataChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSegmentDataChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpSegmentDataType> getSegmentDataChild() {
        if (segmentDataChild == null) {
            segmentDataChild = new ArrayList<OpSegmentDataType>();
        }
        return this.segmentDataChild;
    }
