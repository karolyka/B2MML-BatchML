 ...
 *         &lt;element name="EquipmentSegmentSpecificationPropertyChild" type="{http://www.mesa.org/xml/B2MML}EquipmentSegmentSpecificationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "EquipmentSegmentSpecificationPropertyType", propOrder = {
    ...
    "value",
    "quantity",
    "equipmentSegmentSpecificationPropertyChild",
...
public class EquipmentSegmentSpecificationPropertyType {
    ...
    @XmlElement(name = "EquipmentSegmentSpecificationPropertyChild")
    protected List<EquipmentSegmentSpecificationPropertyType> equipmentSegmentSpecificationPropertyChild;
    ...
    /**
     * Gets the value of the equipmentSegmentSpecificationPropertyChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the equipmentSegmentSpecificationPropertyChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEquipmentSegmentSpecificationPropertyChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EquipmentSegmentSpecificationPropertyType> getEquipmentSegmentSpecificationPropertyChild() {
        if (equipmentSegmentSpecificationPropertyChild == null) {
            equipmentSegmentSpecificationPropertyChild = new ArrayList<EquipmentSegmentSpecificationPropertyType>();
        }
        return this.equipmentSegmentSpecificationPropertyChild;
    }
