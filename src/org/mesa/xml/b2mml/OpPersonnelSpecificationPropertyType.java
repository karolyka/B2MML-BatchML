 ...
 *         &lt;element name="PersonnelSpecificationPropertyChild" type="{http://www.mesa.org/xml/B2MML}OpPersonnelSpecificationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OpPersonnelSpecificationPropertyType {
    ...
    @XmlElement(name = "PersonnelSpecificationPropertyChild")
    protected List<OpPersonnelSpecificationPropertyType> personnelSpecificationPropertyChild;
    ...
    /**
     * Gets the value of the personnelSpecificationPropertyChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the personnelSpecificationPropertyChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPersonnelSpecificationPropertyChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpPersonnelSpecificationPropertyType> getPersonnelSpecificationPropertyChild() {
        if (personnelSpecificationPropertyChild == null) {
            personnelSpecificationPropertyChild = new ArrayList<OpPersonnelSpecificationPropertyType>();
        }
        return this.personnelSpecificationPropertyChild;
    }
