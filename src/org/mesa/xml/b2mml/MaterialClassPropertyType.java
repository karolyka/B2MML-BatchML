 ...
 *         &lt;element name="MaterialClassPropertyChild" type="{http://www.mesa.org/xml/B2MML}MaterialClassPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
public class MaterialClassPropertyType {
    ...
    @XmlElement(name = "MaterialClassPropertyChild")
    protected List<MaterialClassPropertyType> materialClassPropertyChild;
    ...
    /**
     * Gets the value of the materialClassPropertyChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the materialClassPropertyChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMaterialClassPropertyChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MaterialClassPropertyType> getMaterialClassPropertyChild() {
        if (materialClassPropertyChild == null) {
            materialClassPropertyChild = new ArrayList<MaterialClassPropertyType>();
        }
        return this.materialClassPropertyChild;
    }
