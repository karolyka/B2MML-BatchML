...
@XmlSeeAlso({
    ...
    CauseType.class,
    InformationObjectType1Type.class,
    ...
    OperationsEventType1Type.class,
    TransactionVerb1Type.class,
    SpatialDefinitionFormat1Type.class,
    ProcessElementType1Type.class,
    EquipmentProceduralElementType1Type.class,
    Disposition1Type.class,
    ReasonType.class,
    RecipeElementType1Type.class,
    OperationsEventExtension1Type.class,
    LinkType1Type.class,
    OperationsEventLevel1Type.class,
