 ...
 *         &lt;element name="MaterialSubLotChild" type="{http://www.mesa.org/xml/B2MML}MaterialSubLotType" maxOccurs="unbounded" minOccurs="0"/>
...
public class MaterialSubLotType {
    ...
    @XmlElement(name = "MaterialSubLotChild")
    protected List<MaterialSubLotType> materialSubLotChild;
    ...
    /**
     * Gets the value of the materialSubLotChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the materialSubLotChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMaterialSubLotChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MaterialSubLotType> getMaterialSubLotChild() {
        if (materialSubLotChild == null) {
            materialSubLotChild = new ArrayList<MaterialSubLotType>();
        }
        return this.materialSubLotChild;
    }
