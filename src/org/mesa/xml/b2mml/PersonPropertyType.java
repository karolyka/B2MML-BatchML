 ...
 *         &lt;element name="PersonPropertyChild" type="{http://www.mesa.org/xml/B2MML}PersonPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
public class PersonPropertyType {
    ...
    @XmlElement(name = "PersonPropertyChild")
    protected List<PersonPropertyType> personPropertyChild;
    ...
    /**
     * Gets the value of the personPropertyChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the personPropertyChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPersonPropertyChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PersonPropertyType> getPersonPropertyChild() {
        if (personPropertyChild == null) {
            personPropertyChild = new ArrayList<PersonPropertyType>();
        }
        return this.personPropertyChild;
    }
