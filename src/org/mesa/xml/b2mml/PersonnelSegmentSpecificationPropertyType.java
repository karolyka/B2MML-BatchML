 ...
 *         &lt;element name="PersonnalSegmentSpecificationPropertyChild" type="{http://www.mesa.org/xml/B2MML}PersonnelSegmentSpecificationPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "PersonnelSegmentSpecificationPropertyType", propOrder = {
    ...
    "value",
    "quantity",
    "personnalSegmentSpecificationPropertyChild",
...
public class PersonnelSegmentSpecificationPropertyType {
    ...
    @XmlElement(name = "PersonnalSegmentSpecificationPropertyChild")
    protected List<PersonnelSegmentSpecificationPropertyType> personnalSegmentSpecificationPropertyChild;
    ...
    /**
     * Gets the value of the personnalSegmentSpecificationPropertyChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the personnalSegmentSpecificationPropertyChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPersonnalSegmentSpecificationPropertyChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PersonnelSegmentSpecificationPropertyType> getPersonnalSegmentSpecificationPropertyChild() {
        if (personnalSegmentSpecificationPropertyChild == null) {
            personnalSegmentSpecificationPropertyChild = new ArrayList<PersonnelSegmentSpecificationPropertyType>();
        }
        return this.personnalSegmentSpecificationPropertyChild;
    }
