 ...
 *         &lt;element name="EquipmentRequirementPropertyChild" type="{http://www.mesa.org/xml/B2MML}OpEquipmentRequirementPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OpEquipmentRequirementPropertyType {
    ...
    @XmlElement(name = "EquipmentRequirementPropertyChild")
    protected List<OpEquipmentRequirementPropertyType> equipmentRequirementPropertyChild;
    ...
    /**
     * Gets the value of the equipmentRequirementPropertyChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the equipmentRequirementPropertyChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEquipmentRequirementPropertyChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpEquipmentRequirementPropertyType> getEquipmentRequirementPropertyChild() {
        if (equipmentRequirementPropertyChild == null) {
            equipmentRequirementPropertyChild = new ArrayList<OpEquipmentRequirementPropertyType>();
        }
        return this.equipmentRequirementPropertyChild;
    }
