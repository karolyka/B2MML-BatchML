 ...
 *         &lt;element name="MaterialClassBaseID" type="{http://www.mesa.org/xml/B2MML}IdentifierType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="MaterialDefinitionSourceID" type="{http://www.mesa.org/xml/B2MML}IdentifierType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="TestSpecificationID" type="{http://www.mesa.org/xml/B2MML}IdentifierType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="AssemblyClass" type="{http://www.mesa.org/xml/B2MML}MaterialClassType" maxOccurs="unbounded" minOccurs="0"/>
...
public class MaterialClassType {
    ...
    @XmlElement(name = "MaterialClassBaseID")
    protected List<IdentifierType> materialClassBaseID;
    @XmlElement(name = "MaterialClassProperty")
    protected List<MaterialClassPropertyType> materialClassProperty;
    @XmlElement(name = "MaterialDefinitionSourceID")
    protected List<IdentifierType> materialDefinitionSourceID;
    @XmlElement(name = "TestSpecificationID")
    protected List<IdentifierType> testSpecificationID;
    @XmlElement(name = "AssemblyClass")
    protected List<MaterialClassType> assemblyClass;
    ...
    /**
     * Gets the value of the materialClassBaseID property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the materialClassBaseID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMaterialClassBaseID().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<IdentifierType> getMaterialClassBaseID() {
        if (materialClassBaseID == null) {
            materialClassBaseID = new ArrayList<IdentifierType>();
        }
        return this.materialClassBaseID;
    }
    ...
    /**
     * Gets the value of the materialDefinitionSourceID property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the materialDefinitionSourceID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMaterialDefinitionSourceID().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<IdentifierType> getMaterialDefinitionSourceID() {
        if (materialDefinitionSourceID == null) {
            materialDefinitionSourceID = new ArrayList<IdentifierType>();
        }
        return this.materialDefinitionSourceID;
    }
    ...
    /**
     * Gets the value of the assemblyClass property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the assemblyClass property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAssemblyClass().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<MaterialClassType> getAssemblyClass() {
        if (assemblyClass == null) {
            assemblyClass = new ArrayList<MaterialClassType>();
        }
