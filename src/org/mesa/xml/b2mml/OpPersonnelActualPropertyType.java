 ...
 *         &lt;element name="PersonnelActualPropertyChild" type="{http://www.mesa.org/xml/B2MML}OpPersonnelActualPropertyType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OpPersonnelActualPropertyType {
    ...
    @XmlElement(name = "PersonnelActualPropertyChild")
    protected List<OpPersonnelActualPropertyType> personnelActualPropertyChild;
    ...
    /**
     * Gets the value of the personnelActualPropertyChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the personnelActualPropertyChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPersonnelActualPropertyChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpPersonnelActualPropertyType> getPersonnelActualPropertyChild() {
        if (personnelActualPropertyChild == null) {
            personnelActualPropertyChild = new ArrayList<OpPersonnelActualPropertyType>();
        }
        return this.personnelActualPropertyChild;
    }
