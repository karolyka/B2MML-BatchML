 ...
 *         &lt;element name="EquipmentSegmentSpecificationChild" type="{http://www.mesa.org/xml/B2MML}EquipmentSegmentSpecificationType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "EquipmentSegmentSpecificationType", propOrder = {
    ...
    "equipmentSegmentSpecificationChild",
    "testSpecificationID"
})
public class EquipmentSegmentSpecificationType {
    ...
    @XmlElement(name = "EquipmentSegmentSpecificationChild")
    protected List<EquipmentSegmentSpecificationType> equipmentSegmentSpecificationChild;
    ...
    /**
     * Gets the value of the equipmentSegmentSpecificationChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the equipmentSegmentSpecificationChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEquipmentSegmentSpecificationChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EquipmentSegmentSpecificationType> getEquipmentSegmentSpecificationChild() {
        if (equipmentSegmentSpecificationChild == null) {
            equipmentSegmentSpecificationChild = new ArrayList<EquipmentSegmentSpecificationType>();
        }
        return this.equipmentSegmentSpecificationChild;
    }
