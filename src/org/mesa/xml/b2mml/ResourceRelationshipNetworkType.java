 ...
 *         &lt;element name="RRNProperty" type="{http://www.mesa.org/xml/B2MML}RRNPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="ResourceNetworkConnection" type="{http://www.mesa.org/xml/B2MML}ResourceNetworkConnectionType" maxOccurs="unbounded"/>
...
public class ResourceRelationshipNetworkType {
    ...
    @XmlElement(name = "RRNProperty")
    protected List<RRNPropertyType> rrnProperty;
    @XmlElement(name = "ResourceNetworkConnection", required = true)
    ...
    /**
     * Gets the value of the rrnProperty property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the rrnProperty property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRRNProperty().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RRNPropertyType> getRRNProperty() {
        if (rrnProperty == null) {
            rrnProperty = new ArrayList<RRNPropertyType>();
        }
        return this.rrnProperty;
    }
