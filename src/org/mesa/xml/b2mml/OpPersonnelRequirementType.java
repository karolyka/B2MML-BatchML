 ...
 *         &lt;element name="PersonnelRequirementChild" type="{http://www.mesa.org/xml/B2MML}OpPersonnelRequirementType" maxOccurs="unbounded" minOccurs="0"/>
...
public class OpPersonnelRequirementType {
    ...
    @XmlElement(name = "PersonnelRequirementChild")
    protected List<OpPersonnelRequirementType> personnelRequirementChild;
    ...
    /**
     * Gets the value of the personnelRequirementChild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the personnelRequirementChild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPersonnelRequirementChild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OpPersonnelRequirementType> getPersonnelRequirementChild() {
        if (personnelRequirementChild == null) {
            personnelRequirementChild = new ArrayList<OpPersonnelRequirementType>();
        }
        return this.personnelRequirementChild;
    }
